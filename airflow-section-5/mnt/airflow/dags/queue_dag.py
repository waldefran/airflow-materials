...
with DAG(dag_id='queue_dag', schedule_interval='0 0 * * *', default_args=default_args, catchup=False) as dag:
    ...
    t_1_io = BashOperator(task_id='t_1_io', bash_command='echo "I/O intensive task"', queue="worker_io")

    t_2_io = BashOperator(task_id='t_2_io', bash_command='echo "I/O intensive task"', queue="worker_io")

    t_3_io = BashOperator(task_id='t_3_io', bash_command='echo "I/O intensive task"', queue="worker_io")
    ...
    [t_1_io, t_2_io, t_3_io, t_4_cpu, t_5_cpu, t_6_spark] >> task_7
